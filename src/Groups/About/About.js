...
function About({ image, imageAlt, title, height = 200, children }) {
  ...
  if (image) {
    ...
    aboutContentStyle = {
      gridTemplateColumns: `${aboutHeight} auto`,
      gridColumnGap: "30px",
  ...
  return (
    <div className="about-section">
      ...
      <div
        ...
        style={{ ...aboutContentStyle, height: aboutHeight }}
      >
        {aboutImage}
        <div
          className="about-text-container"
          style={{ backgroundColor: colors.aboutContentBackground }}
        >
          <p className="about-text" style={{ color: colors.aboutContentText }}>
            {children}
          </p>
        </div>
      </div>
